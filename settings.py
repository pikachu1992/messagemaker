...
UNABLE ADVISE BEFORE TAXI]',
    ...
    'clr_freq': (
        ...
        ('119.100', '[ON THE GROUND CONTACT APP 119.100]'),
        ('125.550', '[ON THE GROUND CONTACT 125.550]'),
    ),
    'dep_freq': (
...
LPFR = {
    ...
    'clr_freq': (
        ...
        ('118.575', ''),
        ('120.750', '[GND CLOSED]'),
        ('119.400', '[ON THE GROUND CONTACT APP 119.400]'),
...
LPMA = {
    ...
    'clr_freq': (
        ...
        ('119.600', '[ON THE GROUND CONTACT APP 119.600]'),
        ('125.550', '[ON THE GROUND CONTACT 125.550]'),
    ),
    'dep_freq': (),
    'callsigns': (
